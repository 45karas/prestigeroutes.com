...
The Render build uses `npm ci`, runs Prisma generation/schema push, then builds Next.js. The start
command binds Next to `0.0.0.0`, which is required for Render's web service routing.
